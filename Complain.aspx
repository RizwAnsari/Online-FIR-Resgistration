<%@ page title="" language="C#" masterpagefile="~/Main.master" autoeventwireup="true" inherits="Complain, App_Web_v0yngoca" %>
    ...
    <table align="center" class="style2">
        ...
        <tr>
            ...
            <td class="style4">
                <div id="ContentPlaceHolder1_Panel1" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="style8">&nbsp;<strong>MOBILE MISSING FORM</strong></span></div>
        ...
        <tr>
            <td class="style3">
                &nbsp;</td>
            <td class="style4">
                <asp:TextBox runat="server" placeholder="Full Name" Height="25px" Width="500px" 
                    ID="TextBoxFN" MaxLength="30"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td class="style3">
                &nbsp;</td>
            <td class="style4">
                <asp:TextBox ID="TextBoxAltMob" runat="server" placeholder="Alternate Mobile Number" 
                    Height="25px" Width="500px" MaxLength="10"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                    ControlToValidate="TextBoxAltMob" ErrorMessage="Please Enter Your Mobile Number" 
                    Font-Bold="False" ForeColor="Red" SetFocusOnError="True" 
                    style="font-size: large">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                    ControlToValidate="TextBoxAltMob" ErrorMessage="Invalid contact number" 
                    Font-Bold="False" Font-Names="Baskerville Old Face" Font-Size="20px" 
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style6">
                <asp:TextBox ID="TextBoxCompany" runat="server" placeholder="Company Name" 
                    Height="25px" Width="500px" MaxLength="15"></asp:TextBox>
            </td>
            <td class="style7">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" 
                    ControlToValidate="TextBoxCompany" ErrorMessage="Please Enter Your Mobile Company" 
                    Font-Bold="False" ForeColor="Red" SetFocusOnError="True" 
                    style="font-size: large">*</asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style6">
                <asp:TextBox ID="TextBoxModel" runat="server" placeholder="Model Name" 
                    Height="25px" Width="500px" MaxLength="15"></asp:TextBox>
            </td>
            <td class="style7">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" 
                    ControlToValidate="TextBoxModel" ErrorMessage="Please Enter Your Mobile Model" 
                    Font-Bold="False" ForeColor="Red" SetFocusOnError="True" 
                    style="font-size: large">*</asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style6">
                <asp:TextBox ID="TextBoxIMEI" runat="server" placeholder="IMEI No." Height="25px" 
                    Width="500px" MaxLength="15"></asp:TextBox>
            </td>
            <td class="style7">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" 
                    ControlToValidate="TextBoxIMEI" ErrorMessage="Please Enter Your Mobile IMEI" 
                    Font-Bold="False" ForeColor="Red" SetFocusOnError="True" 
                    style="font-size: large">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                    ControlToValidate="TextBoxIMEI" ErrorMessage="Invalid IMEI number" 
        ...
        <tr>
            <td class="style5">
                &nbsp;</td>
            <td class="style6">
                <asp:TextBox ID="TextBoxSPN" runat="server" placeholder="Service Provider Name" 
                    Height="25px" Width="500px" MaxLength="15"></asp:TextBox>
            </td>
            <td class="style7">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" 
                    ControlToValidate="TextBoxSPN" ErrorMessage="Please Enter Service Provider Name" 
                    Font-Bold="False" ForeColor="Red" SetFocusOnError="True" 
                    style="font-size: large">*</asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td class="style6">
                <asp:TextBox ID="TextBoxDes" runat="server" Height="100px" MaxLength="200" 
                    TextMode="MultiLine" Width="498px" placeholder="Brief Description"></asp:TextBox>
            </td>
            <td class="style7">
        ...
        <tr>
            ...
            <td class="style6">
                ...
                <span style="color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: justify; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;" 
                    class="style9">
                <br />
                I hereby agree to get the mobile number blocked with the concerned mobile 
                service provider and in case of defaulting the same, I shall be held 
                responsible.</span><asp:Label ID="CheckStatus" runat="server" ForeColor="Red" 
                    Text="Check Status" Visible="False"></asp:Label>
            </td>
            <td class="style7">
                &nbsp;</td>
        </tr>
